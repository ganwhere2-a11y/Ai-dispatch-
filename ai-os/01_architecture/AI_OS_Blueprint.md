...
- Maya's 6AM report (owner's daily briefing)
...
| **Feedback** | Delivery outcomes, revenue review, decision learning, Shadow Agent | Maya reports, weekly review, Decision Engine |
...
| claude-sonnet-4-6 | Erin (dispatch), Maya (reports), Sales outreach, Support responses, Receptionist LLM |
